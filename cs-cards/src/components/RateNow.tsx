  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch">
        ...
        <div className="lg:w-[280px] w-full shrink-0 flex flex-col justify-between items-center rounded-2xl border border-[#112332] bg-[#071118] p-6 text-center shadow-lg h-full">
          {/* Rewatch icon */}
          ...
          <div className="h-12 flex items-center justify-center">
            <motion.button
              ...
              animate={{
                ...
                color: personalRewatchCount > 0 ? "#001017" : "#ffffff",
        ...
        <div className="flex-1 rounded-2xl border border-[#112332] bg-[#071118] p-6 flex flex-col justify-between shadow-lg gap-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              {/* Profile Avatar */}
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#0a1824] text-[#4df2d6] border border-[#112332]">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="rounded-full bg-[#75D4CB] hover:bg-[#22A498] px-6 py-2.5 text-sm font-sans font-medium text-[#001017] transition-all cursor-pointer self-start select-none shadow-md"
            >
              Submit Your Review →
            </motion.button>
          </form>
